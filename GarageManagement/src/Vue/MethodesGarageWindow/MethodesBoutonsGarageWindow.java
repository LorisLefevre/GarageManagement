...
public class MethodesBoutonsGarageWindow
{
    private static final Logger logger = Logger.getLogger(MethodesBoutonsGarageWindow.class.getName());
    private static MethodesBoutonsGarageWindow instance;

    public static MethodesBoutonsGarageWindow getInstance()
    {
        if (instance == null)
        {
            instance = new MethodesBoutonsGarageWindow();
        }
    ...
    public void BoutonTrier()
    {
        ...
        MethodesGarageWindow.getInstance().filterTableByType(selectedType);
    }
}
